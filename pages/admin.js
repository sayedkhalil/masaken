...
const onpradress = (e) => setproduct({...product,adress:e.target.value})
const onspace = (e) => setproduct({...product,space:e.target.value})
const onbath = (e) => setproduct({...product,bath:e.target.value})
const onroom = (e) => setproduct({...product,room:e.target.value})
const onliving = (e) => setproduct({...product,living:e.target.value})
const onloca = (e) => setproduct({...product,loca:e.target.value})
const onage = (e) => setproduct({...product,age:e.target.value})
const onprprice = (e) => setproduct({...product,price:e.target.value})
// ---------------------------------upload image-------------------------------------------
...
<title>المساكن الرائدة العقارية</title>
...
<div className="tab-content" id="myTabContent">
  ...
  orderss.map((item) => (
    ...
    <td>
        <button className="btn btn-danger" onClick={(x)=>delorders(item.tele)}>مسح</button>
    </td>
  </tr>
...
<div className="input-group input-group-lg border-success my-3 w-75 ms-auto required">
  ...
  <span className="input-group-text bg-primary text-light " id="inputGroup-sizing-sm">نوع العقار </span>
</div>
<div className="input-group input-group-lg border-success my-3 w-75 ms-auto required">
  <input type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"onChange={onpradress} value={product.adress} required />
  <span className="input-group-text bg-primary text-light " id="inputGroup-sizing-sm">العنوان </span>
</div>
<div className="input-group input-group-lg border-success my-3 w-75 ms-auto required">
  <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"onChange={onspace} value={product.space} required />
  <span className="input-group-text bg-primary text-light " id="inputGroup-sizing-sm">المساحة </span>
</div>
<div className="input-group input-group-lg border-success my-3 w-75 ms-auto required">
  <input type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"onChange={onprprice} value={product.price} required />
  <span className="input-group-text bg-primary text-light " id="inputGroup-sizing-sm">السعر </span>
</div>
<div className="input-group input-group-lg border-success my-3 w-75 ms-auto required">
  <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"onChange={onroom} value={product.room} required />
  <span className="input-group-text bg-primary text-light " id="inputGroup-sizing-sm">عدد الغرف </span>
</div>
<div className="input-group input-group-lg border-success my-3 w-75 ms-auto required">
  <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"onChange={onbath} value={product.bath} required />
  <span className="input-group-text bg-primary text-light " id="inputGroup-sizing-sm">عدد دورات المياه </span>
</div>
<div className="input-group input-group-lg border-success my-3 w-75 ms-auto required">
  <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"onChange={onliving} value={product.living} required />
  <span className="input-group-text bg-primary text-light " id="inputGroup-sizing-sm">عدد غرف الجلوس </span>
</div>
<div className="input-group input-group-lg border-success my-3 w-75 ms-auto required">
  <input type="number" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"onChange={onage} value={product.age} required />
  <span className="input-group-text bg-primary text-light " id="inputGroup-sizing-sm">عمر العقار </span>
</div>
<div className="input-group input-group-lg border-success my-3 w-75 ms-auto required">
  <input type="text" className="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm"onChange={onloca} value={product.loca} required />
