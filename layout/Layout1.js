...
<nav className="navbar navbar-light bg-white">
 ...
 {info.snap?<a href={info.snap} className="icon  p-1 github">
  ...
  <a  href="https://api.whatsapp.com/send/?phone=+966506837260&text&type=phone_number&app_absent=0"><i id="coloric"  className="fab fa-whatsapp   "></i></a>
  <a className="ppp" href={`tel:00966506837260}`}>050 683 7260</a>
</div>
<Link href={`/`}>
    <a className="navbar-brand" href="/">
      <img src={info.logo} alt="" width="100" height="70" className="d-inline-block align-text-top"/>
...
<div className={`wrapper p-1 ${call} text-center w-100`}>
 ...
 {info.snap?<a href={info.snap} className="icon  p-1 github">
  ...
  <a  href="https://api.whatsapp.com/send/?phone=+966506837260&text&type=phone_number&app_absent=0"><i id="coloric"  className="fab fa-whatsapp  fa-1x "></i></a>
  <a className="ppp" href={`tel:00966506837260}`}>050 683 7260</a>
</div>
</div>
<div className="fixed ">
  <div className={` bgwa rounded-3`} >
  <a className=" text-success col-8 p-2" href={`https://api.whatsapp.com/send/?phone=+966506837260&text&type=phone_number&app_absent=0`}>
...
<div className="row justify-content-around">
    ...
    <li className="col-12 text-lift">
        ...
        <i className="fas fa-map-marker-alt p-1 fa-2x"></i>
          ...
          <li className="col-12 text-lift">
          <span className="text-dark">
           <a href="tel:00966506837260">050 683 7260</a>
          </span>
