...
<nav className="navbar navbar-light bg-white">
 ...
 {info.snap?<a href={info.snap} className="icon  p-1 github">
  ...
  <a  href="https://api.whatsapp.com/send?phone=00966506837260"><i id="coloric"  className="fab fa-whatsapp   "></i></a>
...
<div className={`wrapper p-1 ${call} text-center w-100`}>
 ...
 {info.snap?<a href={info.snap} className="icon  p-1 github">
  ...
  <a  href="https://api.whatsapp.com/send?phone=00966506837260"><i id="coloric"  className="fab fa-whatsapp  fa-1x "></i></a>
  <a className="ppp" href={`tel:00966506837260}`}>050 683 7260</a>
</div>
</div>
<div className="fixed ">
  <div className={` bgwa rounded-3`} >
  <a className=" text-success col-8 p-2" href={`https://api.whatsapp.com/send/?phone=00966506837260&text&app_absent=0`}>
